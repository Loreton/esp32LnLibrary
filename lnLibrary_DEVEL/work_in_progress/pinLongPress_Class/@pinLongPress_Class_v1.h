...
class PinLongPress_Class {
    public: // Public members (accessible from outside the class)
        ...
        PinLongPress_Class(const char* name,
                            int pin,
        ...
        void setLastPressedLevel(uint8_t value);
...
// --- External functions that operate on PinLongPress_Class objects ---
// These functions might still be external if they involve multiple classes
// (e.g., PinLongPress_Class and PinController_Class