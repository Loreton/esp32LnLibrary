...
// PinLongPress_Class startButton(nullptr, 0, LOW, nullptr, 0); // Temporary initialization, will be assigned in setup
// PinController_Class activeBuzzer(nullptr, 0, LOW);     // Temporary initialization, will be assigned in setup
// PinLongPress_Class pumpState(nullptr, 0, LOW, nullptr, 0);   // Temporary initialization, will be assigned in setup
