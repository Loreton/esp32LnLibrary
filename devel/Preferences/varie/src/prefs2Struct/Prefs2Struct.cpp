...
void setupStruct(bool fClear) {
    Preferences prefs;
    const char *nameSpace="schedule";
    ...
    // - re-read
    size_t schLen = prefs.getBytesLength("schedule"); // bytes dell'intero namespace
